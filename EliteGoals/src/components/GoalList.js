...
//                           <h4 class="text f-w-400">{typeof(prod.payment[0])} </h4>
//                         </div>
                        
//                         <div class="col-sm-6">
//                           <p class="m-b-10 f-w-600">Remaining Installments</p>
//                           {
//                                    prod.payment?.data.map((pay)=>(
//                                     <h4 class="text f-w-400">{pay} </h4>
//                                    )) 
//                           } 
//                         </div>
//                       </div>
...
//  {/* prod.payment[0].payment_count?
//                                 <h4 class="text f-w-400">{prod.payment[0].payment_count}</h4>
//                               :<></> */}
                    ...
                    <div class="card-block">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6">
                          ...
                          <h4 class="text f-w-400">{Object.keys(prod.payment)} </h4> */}
                          {/* <h4>{prod.payment[prod.payment.length-1].payment_count}</h4> */}
                          {/* <h4 class="text f-w-400">{prod.payment?.data.map((pay)=>(   <h4 class="text f-w-400">aaaa</h4>))} </h4> */}

                          {/* {
                            Object.keys(prod.payment).map((k,i)=>(
