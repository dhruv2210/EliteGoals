...
import { ArrowConfig as G6ArrowConfig, Edge, EdgeConfig as G6EdgeConfig, Graph, IEdge, IG6GraphEvent, IGraph, ITreeGraph, IGroup, INode, IPoint, IShape, LabelStyle, ModelConfig, Node, NodeConfig as G6NodeConfig, ShapeStyle, StateStyles, TreeGraphData as G6TreeGraphData, GraphData } from '@antv/g6';
...
declare type PluginContainer<T> = {
    /** tooltip css 类名 */
    className?: string;
    /** tooltip 容器样式 */
    style?: React.CSSProperties;
...
declare type ToolbarCfgCustomContent = {
    zoomIn: () => void;
    zoomOut: () => void;
...
export declare type IMarkerCfg = MarkerCfg | MarkerCfg[] | ((cfg: CardNodeCfg, graph: IGraph | IGroup | undefined) => MarkerCfg | MarkerCfg[]);
...
export declare type CardItem = {
    title?: string;
    items?: CardItems[];
    /** 归一化百分比，仅在 `nodeCfg.percent` 配置时生效 */
    percent?: number;
};
export declare type TreeGraphData = NodeData<CardItem>;
export declare type FlowGraphNodeData = NodeData<CardItem[]>;
...
export { StateStyles, ShapeStyle, Node, Edge, IGraph, ITreeGraph, ModelConfig, IG6GraphEvent, IGroup, LabelStyle, INode, IEdge, Graph, IPoint, IShape, G6TreeGraphData, GraphData, };
