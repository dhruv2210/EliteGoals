...
function useInit(ChartClass, config) {
    ...
    var reactDomToString = function (source, path, type) {
        var statisticCustomHtml = (0, util_2.hasPath)(source, path);
        (0, util_2.setPath)(source, path, function () {
            var arg = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                arg[_i] = arguments[_i];
            }
            var statisticDom = (0, util_2.isType)(statisticCustomHtml, 'Function') ? statisticCustomHtml.apply(void 0, arg) : statisticCustomHtml;
            if ((0, util_2.isType)(statisticDom, 'String') || (0, util_2.isType)(statisticDom, 'Number') || (0, util_2.isType)(statisticDom, 'HTMLDivElement')) {
                return statisticDom;
            }
            return (0, createNode_1.default)(statisticDom, type);
        });
    };
    var processConfig = function () {
        // statistic
        if ((0, util_2.hasPath)(config, ['statistic', 'content', 'customHtml'])) {
            reactDomToString(config, ['statistic', 'content', 'customHtml']);
        }
        if ((0, util_2.hasPath)(config, ['statistic', 'title', 'customHtml'])) {
            reactDomToString(config, ['statistic', 'title', 'customHtml']);
        }
        // tooltip
        if (typeof config.tooltip === 'object') {
            if ((0, util_2.hasPath)(config, ['tooltip', 'container'])) {
                reactDomToString(config, ['tooltip', 'container'], 'tooltip');
            }
            if ((0, util_2.hasPath)(config, ['tooltip', 'customContent'])) {
    ...
    (0, react_1.useEffect)(function () {
        if (chart.current && !(0, util_1.isEqual)(chartOptions.current, config)) {
            ...
            chartOptions.current = (0, util_2.deepClone)(config);
    ...
    (0, react_1.useEffect)(function () {
        ...
        chart.current = (0, util_2.clone)(chartInstance);
        if (onReady) {
