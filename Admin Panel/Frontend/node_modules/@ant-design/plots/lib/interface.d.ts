...
import { Plot, Options, G2, DualAxesOptions, GaugeOptions, BulletOptions, MixOptions, TreemapOptions, TooltipOptions as BaseTooltip } from '@antv/g2plot';
 ...
 */
export declare type AllBaseConfig = Options | DualAxesOptions | GaugeOptions | TinyPlotOptions | BulletOptions | MixOptions | TreemapOptions;
/**
 * @title 图表配置
