...
declare function generateCalendar<DateType>(generateConfig: GenerateConfig<DateType>): (props: CalendarProps<DateType>) => React.ReactElement<any, string | React.JSXElementConstructor<any>>;
