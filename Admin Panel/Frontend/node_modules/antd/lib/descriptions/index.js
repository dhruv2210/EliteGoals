...
function Descriptions(_ref) {
  ...
  return wrapSSR( /*#__PURE__*/React.createElement(DescriptionsContext.Provider, {
    ...
    className: (0, _classnames["default"])(prefixCls, (_classNames = {}, (0, _defineProperty2["default"])(_classNames, prefixCls + "-" + size, size && size !== 'default'), (0, _defineProperty2["default"])(_classNames, prefixCls + "-bordered", !!bordered), (0, _defineProperty2["default"])(_classNames, prefixCls + "-rtl", direction === 'rtl'), _classNames), className, hashId),
    style: style
