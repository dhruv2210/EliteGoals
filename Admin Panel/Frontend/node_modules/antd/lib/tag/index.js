...
var PresetStatusColorRegex = new RegExp("^(" + _colors.PresetStatusColorTypes.join('|') + ")$");
var InternalTag = function InternalTag(_a, ref) {
  ...
  var _useStyle = (0, _style["default"])(prefixCls),
    ...
    hashId = _useStyle2[1];
  var tagClassName = (0, _classnames["default"])(prefixCls, (_classNames = {}, (0, _defineProperty2["default"])(_classNames, prefixCls + "-" + color, presetColor), (0, _defineProperty2["default"])(_classNames, prefixCls + "-has-color", color && !presetColor), (0, _defineProperty2["default"])(_classNames, prefixCls + "-hidden", !visible), (0, _defineProperty2["default"])(_classNames, prefixCls + "-rtl", direction === 'rtl'), _classNames), className, hashId);
  ...
  var tagNode = /*#__PURE__*/React.createElement("span", (0, _extends2["default"])({}, props, {
    ref: ref,
