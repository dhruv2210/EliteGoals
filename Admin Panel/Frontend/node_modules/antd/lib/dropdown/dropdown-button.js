...
var DropdownButton = function DropdownButton(props) {
  ...
  var classes = (0, _classnames["default"])(buttonPrefixCls, compactItemClassnames, className, hashId);
  if ('overlay' in props) {
  ...
  return wrapSSR( /*#__PURE__*/React.createElement(_space["default"].Compact, (0, _extends2["default"])({
    className: classes,
    size: compactSize,
    block: true
