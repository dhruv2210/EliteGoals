...
function InternalTable(props, ref) {
  ...
  var internalRowClassName = function internalRowClassName(record, index, indent) {
    ...
    return (0, _classnames["default"])((0, _defineProperty2["default"])({}, prefixCls + "-row-selected", selectedKeySet.has(getRowKey(record, index))), mergedRowClassName);
  };
  // ========================== Expandable ==========================
  ...
  var _useStyle = (0, _style["default"])(prefixCls),
    ...
    hashId = _useStyle2[1];
  var wrapperClassNames = (0, _classnames["default"])(prefixCls + "-wrapper", (0, _defineProperty2["default"])({}, prefixCls + "-wrapper-rtl", direction === 'rtl'), className, hashId);
  return wrapSSR( /*#__PURE__*/React.createElement("div", {
    ...
    prefixCls: prefixCls,
    className: (0, _classnames["default"])((_classNames3 = {}, (0, _defineProperty2["default"])(_classNames3, prefixCls + "-middle", mergedSize === 'middle'), (0, _defineProperty2["default"])(_classNames3, prefixCls + "-small", mergedSize === 'small'), (0, _defineProperty2["default"])(_classNames3, prefixCls + "-bordered", bordered), (0, _defineProperty2["default"])(_classNames3, prefixCls + "-empty", rawData.length === 0), _classNames3)),
    data: pageData,
    rowKey: getRowKey,
