...
var genMenuItemStyle = function genMenuItemStyle(token) {
  ...
  return _ref4 = {}, (0, _defineProperty2["default"])(_ref4, componentCls + "-item, " + componentCls + "-submenu-title", (_ref2 = {
    position: 'relative',
    display: 'block',
    margin: 0,
    whiteSpace: 'nowrap',
  ...
  }, (0, _defineProperty2["default"])(_ref2, componentCls + "-item-icon, " + iconCls, {
    minWidth: fontSize,
    fontSize: fontSize,
  ...
  }), (0, _defineProperty2["default"])(_ref2, componentCls + "-item-icon", (0, _extends7["default"])({}, (0, _style.resetIcon)())), (0, _defineProperty2["default"])(_ref2, "&" + componentCls + "-item-only-child", (0, _defineProperty2["default"])({}, "> " + iconCls + ", > " + componentCls + "-item-icon", {
    marginInlineEnd: 0
  })), _ref2)), (0, _defineProperty2["default"])(_ref4, componentCls + "-item-disabled, " + componentCls + "-submenu-disabled", (0, _defineProperty2["default"])({
...
var genSubMenuArrowStyle = function genSubMenuArrowStyle(token) {
  ...
  return (0, _defineProperty2["default"])({}, componentCls + "-submenu", (_ref5 = {}, (0, _defineProperty2["default"])(_ref5, "&-expand-icon, &-arrow", {
    position: 'absolute',
    top: '50%',
  ...
  }), (0, _defineProperty2["default"])(_ref5, '&-arrow', {
    // →
    '&::before, &::after': {
      position: 'absolute',
...
var getBaseStyle = function getBaseStyle(token) {
  ...
  (0, _defineProperty2["default"])({
    '': (0, _defineProperty2["default"])({}, "" + componentCls, (0, _extends7["default"])((0, _extends7["default"])({}, (0, _style.clearFix)()), (0, _defineProperty2["default"])({}, "&-hidden", {
      display: 'none'
    })))
  ...
  }), _extends3)), genMenuItemStyle(token)), (_extends5 = {}, (0, _defineProperty2["default"])(_extends5, componentCls + "-item-group", (0, _defineProperty2["default"])({}, componentCls + "-item-group-list", (0, _defineProperty2["default"])({
    margin: 0,
    padding: 0
  ...
  }, "> " + componentCls, (0, _extends7["default"])((0, _extends7["default"])((0, _extends7["default"])({
    borderRadius: borderRadiusLG
  }, genMenuItemStyle(token)), genSubMenuArrowStyle(token)), (_extends4 = {}, (0, _defineProperty2["default"])(_extends4, componentCls + "-item, " + componentCls + "-submenu > " + componentCls + "-submenu-title", {
    borderRadius: radiusSubMenuItem
  }), (0, _defineProperty2["default"])(_extends4, componentCls + "-submenu-title::after", {
    transition: "transform " + motionDurationSlow + " " + motionEaseInOut
  }), _extends4)))), _extends5)), genSubMenuArrowStyle(token)), (_extends6 = {}, (0, _defineProperty2["default"])(_extends6, "&-inline-collapsed " + componentCls + "-submenu-arrow,\n        &-inline " + componentCls + "-submenu-arrow", {
    // ↓
    '&::before': {
  ...
  }), (0, _defineProperty2["default"])(_extends6, componentCls + "-submenu-open" + componentCls + "-submenu-inline > " + componentCls + "-submenu-title > " + componentCls + "-submenu-arrow", {
    // ↑
...
var _default = function _default(prefixCls, injectStyle) {
  var useOriginHook = (0, _internal.genComponentStyleHook)('Menu', function (token, _ref14) {
