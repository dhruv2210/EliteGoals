...
var InternalButton = function InternalButton(props, ref) {
  ...
  var classes = (0, _classnames["default"])(prefixCls, hashId, (_classNames = {}, (0, _defineProperty2["default"])(_classNames, prefixCls + "-" + shape, shape !== 'default' && shape), (0, _defineProperty2["default"])(_classNames, prefixCls + "-" + type, type), (0, _defineProperty2["default"])(_classNames, prefixCls + "-" + sizeCls, sizeCls), (0, _defineProperty2["default"])(_classNames, prefixCls + "-icon-only", !children && children !== 0 && !!iconType), (0, _defineProperty2["default"])(_classNames, prefixCls + "-background-ghost", ghost && !isUnBorderedButtonType(type)), (0, _defineProperty2["default"])(_classNames, prefixCls + "-loading", innerLoading), (0, _defineProperty2["default"])(_classNames, prefixCls + "-two-chinese-chars", hasTwoCNChar && autoInsertSpace && !innerLoading), (0, _defineProperty2["default"])(_classNames, prefixCls + "-block", block), (0, _defineProperty2["default"])(_classNames, prefixCls + "-dangerous", !!danger), (0, _defineProperty2["default"])(_classNames, prefixCls + "-rtl", direction === 'rtl'), (0, _defineProperty2["default"])(_classNames, prefixCls + "-disabled", linkButtonRestProps.href !== undefined && mergedDisabled), _classNames), compactItemClassnames, className);
  ...
  if (linkButtonRestProps.href !== undefined) {
    return wrapSSR( /*#__PURE__*/React.createElement("a", (0, _extends2["default"])({}, linkButtonRestProps, {
      className: classes,
      onClick: handleClick,
      ref: buttonRef
    }), iconNode, kids));
