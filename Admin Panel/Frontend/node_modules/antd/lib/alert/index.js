...
var IconNode = function IconNode(props) {
  ...
  if (icon) {
    return (0, _reactNode.replaceElement)(icon, /*#__PURE__*/React.createElement("span", {
      ...
      return {
        className: (0, _classnames["default"])(prefixCls + "-icon", (0, _defineProperty2["default"])({}, icon.props.className, icon.props.className))
      };
    });
  }
...
var Alert = function Alert(_a) {
  ...
  var alertCls = (0, _classnames["default"])(prefixCls, prefixCls + "-" + type, (_classNames2 = {}, (0, _defineProperty2["default"])(_classNames2, prefixCls + "-with-description", !!description), (0, _defineProperty2["default"])(_classNames2, prefixCls + "-no-icon", !isShowIcon), (0, _defineProperty2["default"])(_classNames2, prefixCls + "-banner", !!banner), (0, _defineProperty2["default"])(_classNames2, prefixCls + "-rtl", direction === 'rtl'), _classNames2), className, hashId);
