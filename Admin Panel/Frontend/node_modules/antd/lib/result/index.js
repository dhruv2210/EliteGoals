...
var Icon = function Icon(_ref) {
  var prefixCls = _ref.prefixCls,
    icon = _ref.icon,
    status = _ref.status;
  var className = (0, _classnames["default"])(prefixCls + "-icon");
...
var Result = function Result(_ref3) {
  ...
  var _useStyle = (0, _style["default"])(prefixCls),
    ...
    hashId = _useStyle2[1];
  var className = (0, _classnames["default"])(prefixCls, prefixCls + "-" + status, customizeClassName, (0, _defineProperty2["default"])({}, prefixCls + "-rtl", direction === 'rtl'), hashId);
