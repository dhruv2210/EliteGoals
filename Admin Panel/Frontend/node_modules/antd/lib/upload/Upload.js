...
var InternalUpload = function InternalUpload(props, ref) {
  ...
  var rtlCls = (0, _defineProperty2["default"])({}, prefixCls + "-rtl", direction === 'rtl');
  if (type === 'drag') {
    var _classNames;
    var dragCls = (0, _classnames["default"])(prefixCls, (_classNames = {}, (0, _defineProperty2["default"])(_classNames, prefixCls + "-drag", true), (0, _defineProperty2["default"])(_classNames, prefixCls + "-drag-uploading", mergedFileList.some(function (file) {
      return file.status === 'uploading';
    })), (0, _defineProperty2["default"])(_classNames, prefixCls + "-drag-hover", dragState === 'dragover'), (0, _defineProperty2["default"])(_classNames, prefixCls + "-disabled", mergedDisabled), (0, _defineProperty2["default"])(_classNames, prefixCls + "-rtl", direction === 'rtl'), _classNames), hashId);
  ...
  var uploadButtonCls = (0, _classnames["default"])(prefixCls, prefixCls + "-select", (0, _defineProperty2["default"])({}, prefixCls + "-disabled", mergedDisabled));
