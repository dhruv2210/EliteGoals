...
var ListItem = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  if (listType === 'picture' || listType === 'picture-card') {
    if (mergedStatus === 'uploading' || !file.thumbUrl && !file.url) {
      var _classNames;
      var uploadingClassName = (0, _classnames["default"])((_classNames = {}, (0, _defineProperty2["default"])(_classNames, prefixCls + "-list-item-thumbnail", true), (0, _defineProperty2["default"])(_classNames, prefixCls + "-list-item-file", mergedStatus !== 'uploading'), _classNames));
      ...
      var aClassName = (0, _classnames["default"])((_classNames2 = {}, (0, _defineProperty2["default"])(_classNames2, prefixCls + "-list-item-thumbnail", true), (0, _defineProperty2["default"])(_classNames2, prefixCls + "-list-item-file", isImgUrl && !isImgUrl(file)), _classNames2));
  ...
  var listItemClassName = (0, _classnames["default"])(prefixCls + "-list-item", prefixCls + "-list-item-" + mergedStatus);
  ...
  var listItemNameClass = (0, _classnames["default"])(prefixCls + "-list-item-name");
  var fileName = file.url ? [/*#__PURE__*/React.createElement("a", (0, _extends2["default"])({
    key: "view",
    target: "_blank",
    rel: "noopener noreferrer",
