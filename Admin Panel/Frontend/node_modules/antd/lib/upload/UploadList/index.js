...
var InternalUploadList = function InternalUploadList(props, ref) {
  ...
  var listClassNames = (0, _classnames["default"])((_classNames = {}, (0, _defineProperty2["default"])(_classNames, prefixCls + "-list", true), (0, _defineProperty2["default"])(_classNames, prefixCls + "-list-" + listType, true), _classNames));
  // >>> Motion config
  ...
  var listItemMotion = (0, React.useMemo)(function () {
    var motion = (0, _extends2["default"])({}, (0, _motion["default"])(rootPrefixCls));
