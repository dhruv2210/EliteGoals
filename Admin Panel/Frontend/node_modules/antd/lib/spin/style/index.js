...
var genSpinStyle = function genSpinStyle(token) {
  ...
  return (0, _defineProperty2["default"])({}, "" + token.componentCls, (0, _extends3["default"])((0, _extends3["default"])({}, (0, _style.resetComponent)(token)), (_extends2 = {
    ...
    '&-nested-loading': (_nestedLoading = {
      position: 'relative'
    }, (0, _defineProperty2["default"])(_nestedLoading, "> div > " + token.componentCls, (_ref = {
      position: 'absolute',
      top: 0,
      insetInlineStart: 0,
      zIndex: 4,
    ...
    }, (0, _defineProperty2["default"])(_ref, token.componentCls + "-dot", {
      position: 'absolute',
      top: '50%',
      insetInlineStart: '50%',
    ...
    }), (0, _defineProperty2["default"])(_ref, '&-sm', (_sm = {}, (0, _defineProperty2["default"])(_sm, token.componentCls + "-dot", {
      margin: -token.spinDotSizeSM / 2
    }), (0, _defineProperty2["default"])(_sm, token.componentCls + "-text", {
      paddingTop: (token.spinDotSizeSM - token.fontSize) / 2 + 2
    }), (0, _defineProperty2["default"])(_sm, "&" + token.componentCls + "-show-text " + token.componentCls + "-dot", {
      marginTop: -(token.spinDotSizeSM / 2) - 10
    }), _sm)), (0, _defineProperty2["default"])(_ref, '&-lg', (_lg = {}, (0, _defineProperty2["default"])(_lg, token.componentCls + "-dot", {
      margin: -(token.spinDotSizeLG / 2)
    }), (0, _defineProperty2["default"])(_lg, token.componentCls + "-text", {
      paddingTop: (token.spinDotSizeLG - token.fontSize) / 2 + 2
    }), (0, _defineProperty2["default"])(_lg, "&" + token.componentCls + "-show-text " + token.componentCls + "-dot", {
      marginTop: -(token.spinDotSizeLG / 2) - 10
    }), _lg)), _ref)), (0, _defineProperty2["default"])(_nestedLoading, token.componentCls + "-container", {
      position: 'relative',
