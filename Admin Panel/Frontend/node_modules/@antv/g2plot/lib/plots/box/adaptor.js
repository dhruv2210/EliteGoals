...
function adaptor(params) {
    return utils_1.flow(field, outliersPoint, meta, axis, legend, common_1.tooltip, common_1.annotation(), common_1.interaction, common_1.animation, common_1.theme)(params);
}
