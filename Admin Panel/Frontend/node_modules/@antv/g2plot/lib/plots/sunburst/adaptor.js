...
function adaptor(params) {
    ...
    return utils_1.flow(common_1.theme, common_1.pattern('sunburstStyle'), geometry, axis, meta, common_1.legend, coordinate, tooltip, label, interaction, common_1.animation, common_1.annotation())(params);
}
