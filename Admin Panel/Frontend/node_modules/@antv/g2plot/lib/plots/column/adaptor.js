...
function geometry(params) {
    ...
    var percentData = isPercent && isGroup && isStack
        ...
        : percent_1.getDataWhetherPercentage(data, yField, xField, yField, isPercent);
    var chartData = [];
...
function adaptor(params, isBar) {
    ...
    pattern_1.pattern('columnStyle'), common_1.state, common_1.transformations('rect'), geometry, meta, axis, legend, columnTooltip, common_1.slider, common_1.scrollbar, label, brush_1.brushInteraction, common_1.interaction, common_1.animation, common_1.annotation(), conversion_tag_1.conversionTag(options.yField, !isBar, !!seriesField), // 有拆分的时候禁用转化率
