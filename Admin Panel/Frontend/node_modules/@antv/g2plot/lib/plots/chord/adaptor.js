...
function transformData(params) {
    ...
    // 将数据转换为node link格式
    var chordLayoutInputData = utils_1.transformDataToNodeLinkData(data, sourceField, targetField, weightField);
...
function animation(params) {
    ...
    utils_1.addViewAnimation(chart, animation, utils_1.getAllGeometriesRecursively(chart));
    return params;
}
/**
 * 弦图适配器
