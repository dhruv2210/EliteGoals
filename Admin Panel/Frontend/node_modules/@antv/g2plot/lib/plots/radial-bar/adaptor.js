...
function geometry(params) {
    ...
    // 处理不合法的数据
    var processData = utils_1.processIllegalData(data, yField);
...
function meta(params) {
    ...
    var actualData = isStack && !isGroup && colorField ? utils_2.getStackedData(data, xField, yField) : data;
    var processData = utils_1.processIllegalData(actualData, yField);
    return utils_1.flow(common_1.scale((_a = {},
        _a[yField] = {
            min: 0,
            max: utils_2.getScaleMax(maxAngle, yField, processData),
        },
        _a)))(params);
}
exports.meta = meta;
