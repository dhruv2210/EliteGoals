...
function adaptor(params) {
    ...
    return utils_1.flow(common_1.theme, pattern_1.pattern('columnStyle'), geometry, meta, axis, common_1.state, label, common_1.tooltip, common_1.interaction, common_1.animation)(params);
}
