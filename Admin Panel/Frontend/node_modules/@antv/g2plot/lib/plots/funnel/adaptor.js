...
function defaultOptions(params) {
    ...
    return utils_1.deepAssign({ options: defaultOption }, params, { options: { funnelStyle: style, data: util_1.clone(data) } });
}
/**
 * geometry处理
 * @param params
...
function adaptor(params) {
    return utils_1.flow(defaultOptions, geometry, meta, axis, common_1.tooltip, interaction, legend, common_1.animation, common_1.theme, common_1.annotation())(params);
}
