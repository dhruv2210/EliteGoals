...
function geometry(params) {
    ...
    var chartData = percent_1.getDataWhetherPercentage(data, yField, xField, yField, isPercent);
    ...
    var lineParams = {
        chart: chart,
        options: utils_1.deepAssign({ line: { size: 2 } }, util_1.omit(options, ['state']), {
...
function adaptor(params) {
    ...
    return utils_1.flow(common_1.theme, common_1.pattern('areaStyle'), common_1.transformations('rect'), geometry, adaptor_1.meta, adjust, adaptor_1.axis, adaptor_1.legend, common_1.tooltip, label, common_1.slider, common_1.annotation(), common_1.interaction, common_1.animation, common_1.limitInPlot)(params);
}
