                ...
                shape: shape &&
                    (sizeField
                        ? function (dautm) {
                            ...
                            min = util_1.isNumber(min) ? min : Math.min.apply(Math, field);
                            max = util_1.isNumber(max) ? max : Math.max.apply(Math, field);
...
function coordinate(params) {
    ...
    var coordinateOption = utils_1.deepAssign({ actions: [] }, coordinate !== null && coordinate !== void 0 ? coordinate : { type: 'rect' });
    if (reflect) {
...
function adaptor(params) {
    ...
    return utils_1.flow(common_1.theme, common_1.pattern('heatmapStyle'), meta, coordinate, geometry, axis, legend, common_1.tooltip, label, common_1.annotation(), common_1.interaction, common_1.animation, common_1.state)(params);
}
