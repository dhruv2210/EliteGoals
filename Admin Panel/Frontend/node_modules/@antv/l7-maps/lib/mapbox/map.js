 ...
 * AMapService
 */
var MapboxService = (_dec = (0, _inversify.injectable)(), _dec(_class = /*#__PURE__*/function (_BaseMapService) {
  (0, _inherits2.default)(MapboxService, _BaseMapService);
  var _super = _createSuper(MapboxService);
  function MapboxService() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "version", _version.Version.MAPBOX);
    return _this;
  }
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              if (mapInstance) {
                ...
                // @ts-ignore
                this.map = new window.mapboxgl.Map((0, _objectSpread2.default)({
