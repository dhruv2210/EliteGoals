...
var TileDebugLayer = /*#__PURE__*/function (_BaseLayer) {
  ...
  function TileDebugLayer() {
    var _this;
    (0, _classCallCheck2.default)(this, TileDebugLayer);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _super.call.apply(_super, [this].concat(args));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "type", 'TileDebugLayer');
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "zIndex", 10000);
  ...
  (0, _createClass2.default)(TileDebugLayer, [{
    key: "buildModels",
    value: function () {
